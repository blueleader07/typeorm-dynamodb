...
public class Pipeline {
  private static final AddOns ADD_ONS = new AddOns().buildAddOns(/* Add an available build add-on here */).deploymentAddOns(/* Add an available deployment add-on here */);
  ...
  public static void main(String[] args) {
     ...
     */
    new NodeModuleBuild(PIPELINE_CONFIGURATION).addOns(ADD_ONS).publish();
  }
}
